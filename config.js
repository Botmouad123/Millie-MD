...
global.url = 'https://chat.whatsapp.com/KUGDNzTkom7Co72LHCzYiS'

//HEROKU  VARS
global.thumburl = process.env.IMAGE || 'https://telegra.ph/file/59a92870ab48d1f847d31.jpg'
global.packname = process.env.PACKNAME ||'ᴍᴏᴜᴀᴅ ᴇʟ'
global.author = process.env.AUTHOR ||'ᴍᴏᴜᴀᴅ ᴇʟ'
global.name = 'Millie MULTI-DEVICE'
global.session = process.env.SESSION_ID|| ''
global.wm = process.env.WATERMARK|| 'ᴍᴏᴜᴀᴅ ᴇʟ'
global.owner_name = process.env.OWNER_NAME || 'MOUAD EL'
